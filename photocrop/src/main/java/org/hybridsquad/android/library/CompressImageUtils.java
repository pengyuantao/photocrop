...
public class CompressImageUtils {
    ...
    public static final String TAG = "CompressImageUtils";
    ...
    public static void compressImageFile(CropParams cropParams, Uri originUri, Uri compressUri) {
        ...
        try {
            ...
            int minSideLength = cropParams.getCompressWidth() > cropParams.getCompressHeight()
                    ? cropParams.getCompressHeight() : cropParams.getCompressWidth();
            options.inSampleSize = computeSampleSize(options, minSideLength, cropParams.getCompressWidth() * cropParams.getCompressHeight());
